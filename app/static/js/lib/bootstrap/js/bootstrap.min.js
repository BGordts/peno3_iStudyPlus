...
function(){b.fn.collapse=f;return this};b(document).on("click.bs.collapse.data-api","[data-toggle=collapse]",function(a){var d=b(this),e,c=d.attr("data-followers"),h=b(c),c=d.attr("data-follow-class");if(!h.hasClass("is_transitioning"))if(h.toggleClass(c),h.toggleClass("is_transitioning"),setTimeout(function(){h.toggleClass("is_transitioning")},350),d.attr("data-is-target"))d=d.attr("data-is-target")||a.preventDefault()||(e=d.attr("href"))&&e.replace(/.*(?=#[^\s]+$)/,""),b(d).toggleClass("is_off");
else{a=d.attr("data-target")||a.preventDefault()||(e=d.attr("href"))&&e.replace(/.*(?=#[^\s]+$)/,"");e=b(a);var c=(a=e.data("bs.collapse"))?"toggle":d.data(),k=d.attr("data-parent"),l=k&&b(k);a&&a.transitioning||(l&&l.find('[data-toggle=collapse][data-parent="'+k+'"]').not(d).addClass("collapsed"),d[e.hasClass("in")?"addClass":"removeClass"]("collapsed"));e.collapse(c)}})}(window.jQuery);
