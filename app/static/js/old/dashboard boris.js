...
.directive("coursepanel", function () {
    return {
        ...
        link: function (scope, element, attrs) {
            scope.$watch('selectedItem', function (newVal, oldVal) {
                if (typeof nevVal === "undefined" && newVal == null) {
                    ...
                    console.log("scope item: " + scope.item["data" + newVal.id])
                    
                    scope.getDataFormServer();
                }
            });
        },
        controller: function ($scope, $http) {
            ...
            $scope.getDataFormServer = function(){
            	$http({method: 'GET', url: '/statistics/getEfficiencyForSensor', params: {'userID':1, 'sensor_type':'temperature'}})
